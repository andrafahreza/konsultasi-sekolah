...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Data Verifikasi Siswa</h5>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
    ...
    <div class="modal fade verif" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-muted mb-4"> Yakin ingin memverifikasi pengguna ini? </p>
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('verif-siswa') }}" method="POST">
                                @csrf
