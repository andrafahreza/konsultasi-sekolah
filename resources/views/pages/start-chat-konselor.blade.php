        ...
        <div class="chat-leftsidebar">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="pills-end">
                    ...
                    <div class="row p-4">
                        <a href="{{ route('list-chat-konselor') }}" class="btn btn-primary">Akhiri</a>
                    </div>
                    <!-- end tab contact -->
                </div>
                <!-- end tab pane -->
                ...
                <div class="w-100 overflow-hidden position-relative">
                    ...
                    <div class="position-relative">
                        ...
                        <div class="chat-input-section p-3 p-lg-4 border-top border-2">
                            ...
                            <form action="{{ route('send-chat-konselor') }}" id="chatinput-form" method="POST" enctype="multipart/form-data">
